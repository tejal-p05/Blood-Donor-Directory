...
if($pic_upload == 1) {
    ...
    if($query->rowCount() == 0) {
        $sql = "INSERT INTO tblblooddonars (FullName, MobileNumber, EmailId, Age, Gender, BloodGroup, Address, Message, status, Password, image) 
                VALUES (:fullname, :mobile, :email, :age, :gender, :bloodgroup, :address, :message, :status, :password, :image)";
...
<?php }} ?>
								...
								<div class="form-group">
                                    ...
                                    <input type="file" class="form-control" name="pic" id="pic" required data-parsley-trigger="keyup" class="form-control" />
                                </div>
                                <div class="form-group">
                                    <label>Address</label>
